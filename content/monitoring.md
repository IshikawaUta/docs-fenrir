...
Fenrir v4.4.0 includes a built-in monitoring dashboard for tracking application health, traffic analysis, and alerts. The dashboard is powered by `fenrir.features.init_fenrir_monitoring()` and provides both a web UI and REST API endpoints.
...
app = Fenrir(title="My App", version="4.4.0")
...
app = Fenrir(title="Production App", version="4.4.0")
